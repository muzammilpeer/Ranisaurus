...
//    adding appirater for asking user to rate the app on appstore
//    [Appirater setDaysUntilPrompt:7];
    [Appirater setTimeBeforeReminding:15];
    [Appirater setUsesUntilPrompt:5];
    [Appirater setSignificantEventsUntilPrompt:-1];
    
    //To disable Crashlytics for simulator
    if (!DEBUG) {
...
{
    [[NSNotificationCenter defaultCenter] removeObserver:self name:kNotification_DataSynced object:nil];
}
